# ADEXLLM Web UI Troubleshooting Guide
...
It is crucial to include the `/api` at the end of the URL to ensure that the ADEXLLM Web UI can communicate with the server.
